...
- Atualmente ~270 mil UCs no Mundo<sup>1</sup>
...
Meta da **Convenção da Biodiversidade (CDB)** para 2030: 
- = 30% da superficie terrestre e marinha<sup>1</sup>;
- Atualmente ~270 mil UCs no Mundo
- 1551 UCs na Mata Atlântica<sup>2</sup>
...
### **Dados disponíveis: Visão geral**: "Plano de manejo gera um viés nos inventários da biodiversidade?" 
...
- 1,395 espécies 
- 33% UCs com registros de espécies ameaçadas **(flora)**
...
- Planos de manejo são muitas vezes dependentes de dados secuntários.
...
- UCs com plano de manejo tem maior número de espécies ameaçadas;
...
pagedown::chrome_print("2022-Seminario-INMA.html")
```  
